#############################################################################
# Makefile for building: memeview
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  memeview.pro
# Template: app
# Command: /usr/lib64/qt6/bin/qmake -o Makefile memeview.pro ' QMAKE_CFLAGS_DEBUG=-O2 -g ' ' QMAKE_CFLAGS_RELEASE=-O2 -g ' ' QMAKE_CXXFLAGS_DEBUG=-O2 -g ' ' QMAKE_CXXFLAGS_RELEASE=-O2 -g ' ' QMAKE_LFLAGS_DEBUG=' ' QMAKE_LFLAGS_RELEASE=' ' QMAKE_STRIP='
#############################################################################
...
CFLAGS        = -pipe -O2 -g -O0 -g -fno-omit-frame-pointer -Wall -Wextra -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -O0 -g -fno-omit-frame-pointer -std=gnu++1z -Wall -Wextra -D_REENTRANT $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = memeview1.0.0
DISTDIR = /home/boa/src/memeview/.tmp/memeview1.0.0
LINK          = g++
...
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		memeview.pro  main.cpp
QMAKE_TARGET  = memeview
DESTDIR       = 
TARGET        = memeview
...
Makefile: memeview.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile memeview.pro ' QMAKE_CFLAGS_DEBUG=-O2 -g ' ' QMAKE_CFLAGS_RELEASE=-O2 -g ' ' QMAKE_CXXFLAGS_DEBUG=-O2 -g ' ' QMAKE_CXXFLAGS_RELEASE=-O2 -g ' ' QMAKE_LFLAGS_DEBUG=' ' QMAKE_LFLAGS_RELEASE=' ' QMAKE_STRIP='
...
moc_predefs.h: /usr/lib64/qt6/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -g -O0 -g -fno-omit-frame-pointer -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib64/qt6/mkspecs/features/data/dummy.cpp
...
main.moc: main.cpp \
	...
	/usr/lib64/qt6/libexec/moc $(DEFINES) --include /home/boa/src/memeview/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/boa/src/memeview -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtCore -I/usr/include/c++/15 -I/usr/include/c++/15/x86_64-redhat-linux -I/usr/include/c++/15/backward -I/usr/lib/gcc/x86_64-redhat-linux/15/include -I/usr/local/include -I/usr/include main.cpp -o main.moc
